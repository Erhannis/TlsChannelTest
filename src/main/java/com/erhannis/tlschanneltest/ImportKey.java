 ...
 * ($home/keystore.ImportKey). If the keystore is already present, it is simply
 * deleted. Both the key and the certificate file must be in DER-format. The key
 * must be encoded with PKCS#8-format. The certificate must be encoded in
 * X.509-format.
 *
 *
 *
...
public class ImportKey {
     ...
     * named keystore.ImportKey and placed in your home directory.
     *
